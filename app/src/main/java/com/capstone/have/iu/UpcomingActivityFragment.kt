 ...
 * Use the [UpcomingActivityFragment.newInstance] factory method to
...
class UpcomingActivityFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment UpcomingActivityFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            UpcomingActivityFragment().apply {
